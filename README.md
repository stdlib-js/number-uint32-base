...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { add, fromBinaryStringUint32, identity, mul, muldw, rotl32, rotr32, sub, toBinaryStringUint32, uint32ToInt32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.1-esm/index.mjs';
```
