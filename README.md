...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { add, fromBinaryStringUint32, identity, mul, muldw, rotl32, rotr32, sub, toBinaryStringUint32, uint32ToInt32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.1-deno/mod.js';
```
...
-   <span class="signature">[`identity( x )`][@stdlib/number/uint32/base/identity]</span><span class="delimiter">: </span><span class="description">evaluate the identity function of an unsigned 32-bit integer.</span>
...
[test-image]: https://github.com/stdlib-js/number-uint32-base/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/number-uint32-base/actions/workflows/test.yml?query=branch:v0.3.1
...
[@stdlib/number/uint32/base/add]: https://github.com/stdlib-js/number-uint32-base-add/tree/deno

[@stdlib/number/uint32/base/from-binary-string]: https://github.com/stdlib-js/number-uint32-base-from-binary-string/tree/deno

[@stdlib/number/uint32/base/identity]: https://github.com/stdlib-js/number-uint32-base-identity/tree/deno

[@stdlib/number/uint32/base/mul]: https://github.com/stdlib-js/number-uint32-base-mul/tree/deno

[@stdlib/number/uint32/base/muldw]: https://github.com/stdlib-js/number-uint32-base-muldw/tree/deno
...
[@stdlib/number/uint32/base/sub]: https://github.com/stdlib-js/number-uint32-base-sub/tree/deno
