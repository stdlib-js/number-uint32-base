...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { add, fromBinaryStringUint32, identity, mul, muldw, rotl32, rotr32, sub, toBinaryStringUint32, uint32ToInt32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base@v0.3.0-esm/index.mjs';
```
...
[@stdlib/number/uint32/base/add]: https://github.com/stdlib-js/number-uint32-base-add/tree/esm

[@stdlib/number/uint32/base/from-binary-string]: https://github.com/stdlib-js/number-uint32-base-from-binary-string/tree/esm

[@stdlib/number/uint32/base/identity]: https://github.com/stdlib-js/number-uint32-base-identity/tree/esm

[@stdlib/number/uint32/base/mul]: https://github.com/stdlib-js/number-uint32-base-mul/tree/esm

[@stdlib/number/uint32/base/muldw]: https://github.com/stdlib-js/number-uint32-base-muldw/tree/esm
...
[@stdlib/number/uint32/base/sub]: https://github.com/stdlib-js/number-uint32-base-sub/tree/esm
